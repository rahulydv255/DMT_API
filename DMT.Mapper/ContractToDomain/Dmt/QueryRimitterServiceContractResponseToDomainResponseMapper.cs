...
namespace DMT.Mapper.ContractToDomain.Dmt
{
    public class QueryRimitterServiceContractResponseToDomainResponseMapper : Profile
    {
        public QueryRimitterServiceContractResponseToDomainResponseMapper()
        {
     ...
     CreateMap<DMT.ServiceIntegration.DataContract.QueryRimitterServiceContractResponse.Data, DMT.Domain.DMT.QueryRemiterDomainRespoonse.Data>()
