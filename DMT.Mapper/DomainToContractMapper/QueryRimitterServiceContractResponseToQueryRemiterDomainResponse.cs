...
namespace DMT.Mapper.DomainToContractMapper
{
    public class QueryRimitterServiceContractResponseToQueryRemiterDomainResponse : Profile
    {
        public QueryRimitterServiceContractResponseToQueryRemiterDomainResponse()
        {
            ...
            CreateMap<DMT.Domain.DMT.QueryRemiterDomainRespoonse.Data, DMT.Contracts.DMT.Data>()
